...
def register(mcp: FastMCP) -> None:
    ...
    @mcp.tool(name="action_log_get_by_id_v2", description="Action Log: Get By Id V2")
    async def action_log_get_by_id_v2(
        e_action_log_id: Annotated[str | None, Field(default=None)] = None,
        source_table_id: Annotated[int | None, Field(default=None)] = None,
        add_to_application: Annotated[bool | None, Field(default=None)] = None,
        get_all_parents: Annotated[bool | None, Field(default=None)] = None,
        opened_from_link: Annotated[bool | None, Field(default=None)] = None,
        organization_id: Annotated[
            str | None,
            Field(
                description="Override the default organization (ManagedOrganizationId header).",
        ...
        params = {
            "eActionLogId": e_action_log_id,
            "sourceTableId": source_table_id,
            "addToApplication": add_to_application,
            "getAllParents": get_all_parents,
            "openedFromLink": opened_from_link,
        }
    ...
    async def action_log_get_all_for_file_history_v2(
        source_table_id: Annotated[int | None, Field(default=None)] = None,
        hostname: Annotated[str | None, Field(default=None)] = None,
        full_path: Annotated[str | None, Field(default=None)] = None,
        computer_id: Annotated[str | None, Field(default=None)] = None,
        page_number: Annotated[int | None, Field(default=None)] = None,
        page_size: Annotated[int | None, Field(default=None)] = None,
        organization_id: Annotated[
            str | None,
            Field(
                description="Override the default organization (ManagedOrganizationId header).",
    ...
    @mcp.tool(
        name="action_log_get_file_download_details_by_id",
        description="Action Log: Get File Download Details By Id",
    )
